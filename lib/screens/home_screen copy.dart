...
//           ),
//           // Resto del contenido, como el FutureBuilder para los productos
//            // Espacio entre las categorías y el listado de productos
//           const SizedBox(height: 16.0),

//           // Carrusel de productos (GridView horizontal)
//           Expanded(
...
//                     scrollDirection: Axis.horizontal, // Hacer el listado horizontal
//                     itemCount: snapshot.data!.length,
//                     itemBuilder: (context, index) {
//                       final product = snapshot.data![index];
//                       return SizedBox(
//                         width: 200.0, // Ancho fijo para cada tarjeta
//                         child: ProductCard(
//                           id: product.id,
//                           title: product.name,
//                           price: product.price,
